<div>
    <div class="x_panel">
        <div class="x_title">
            <h2>Listado |<small>Provincias</small></h2>
                ...
                <table class="table table-bordered table-striped mt-1">
                    <thead class="text-white" style="background: #003471">
                        <tr>
                            ...
                            <th class="table-th text-white text-center">DEPARTAMENTO</th>
            ...
            <div class="row">
                <div class="col-md-12">
                    <a class="btn btn-success" href="javascript:void(0)" role="button" data-toggle="modal"
                        data-target="#modalDepartamento">Registrar Nueva Provincia</a>
                </div>
            </div>
        </div>
    </div>
    @include('livewire.ubicacion.provincias.form')
    <script>

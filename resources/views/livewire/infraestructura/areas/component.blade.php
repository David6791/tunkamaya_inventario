<div>
    <div class="x_panel">
        <div class="x_title">
            <h2>Listado |<small>Areas</small></h2>
                ...
                <table class="table table-bordered table-striped mt-1">
                    <thead class="text-white" style="background: #003471">
                        <tr>
                            ...
                            <th class="table-th text-white text-center">NOMBRES AREA</th>
                            <th class="table-th text-white text-center">BOQUE</th>
                    ...
                    <tbody>
                        @foreach ($data as $r)
                            <tr>
                                ...
                                <td>{{ $r->name }}</td>
                                <td>{{ $r->bloque_name }}</td>
                                <td>{{ $r->responsable_name . ' ' . $r->apellidos }}</td>
                                <td>
                                    <span
            ...
            <div class="row">
                <div class="col-md-12">
                    <a class="btn btn-success" href="javascript:void(0)" role="button" data-toggle="modal"
                        data-target="#modalAreas">Registrar Nueva Area</a>
                </div>
            </div>
        </div>
    </div>
    @include('livewire.infraestructura.areas.form')
    <script>
